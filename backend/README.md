# Academe Backend - Go API

Backend modular monolítico construido con Go para la plataforma Academe.
...
```env
DATABASE_URL=postgres://academe:academe_dev@localhost:5432/academe?sslmode=disable
...
```bash
# Build local
go build -o academe cmd/server/main.go
